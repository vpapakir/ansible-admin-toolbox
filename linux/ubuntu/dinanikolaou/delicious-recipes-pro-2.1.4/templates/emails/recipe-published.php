...
<p style="margin-top: 0;margin-bottom: 40px"><?php esc_html_e( 'We’re happy to inform you that your recipe has been published.', 'delicious-recipes-pro' );?></p>
<p style="margin-top: 0;margin-bottom: 40px"><?php esc_html_e( 'Your Published Recipe detail is as follow:', 'delicious-recipes-pro' );?></p>
