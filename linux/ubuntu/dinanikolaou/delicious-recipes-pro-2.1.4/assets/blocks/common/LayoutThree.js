		...
		return (
			<Fragment>
				<div
					...
					className="dr-summary-holder dr-recipe-card-block layout-3"
					style={{
						background: `rgba(${delrcp.setting_options.primaryColorRGB}, 0.05)`,
					}}
				>
					<div className="dr-post-summary layout-3">
						...
						<div className="dr-extra-meta">
							...
							{recipe.difficulty_level && (
								<span className="dr-sim-metaa dr-lavel">
									<span className="dr-meta-title">
										{__("Difficulty:", "delicious-recipes-pro")}
									</span>
							...
							{recipe.no_of_servings && (
								<span className="dr-sim-metaa dr-yields">
									<span className="dr-meta-title">
										{__("Servings:", "delicious-recipes-pro")}
									</span>
							...
							{recipe.calories && (
								<span className="dr-sim-metaa dr-calorie">
									<span className="dr-meta-title">
										{__("Calories:", "delicious-recipes-pro")}
									</span>
									<b>{recipe.calories}</b>
								</span>
							)}
