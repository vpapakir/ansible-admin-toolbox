<?php
/**
 * Cookery Customizer Slider Control.
 * 
 * @package Cookery
*/
...
if ( ! class_exists( 'Cookery_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Cookery_Slider_Control extends WP_Customize_Control {

		public $type = 'cookery-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'cookery-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'cookery-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
